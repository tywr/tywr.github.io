...
If you are curious about how this sounds, you can download the software from the repository [here](https://github.com/tywr/orbital-bass-engine). It is open-source and free to use.
